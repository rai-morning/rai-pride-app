  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white">
      <header className="bg-[#12121f] border-b border-[#ff2d78]/20 px-4 h-14 flex items-center gap-3">
        ...
        <h1 className="text-base font-bold text-[#00f5ff] neon-text-cyan">ヘルプ</h1>
      </header>
      <div className="w-full max-w-[480px] mx-auto px-4 py-6 space-y-4">
        <div className="bg-[#12121f] border border-[#ff2d78]/20 rounded-xl p-4">
          <p className="text-sm text-white font-medium mb-2">よくある質問</p>
          <p className="text-xs text-[#8888aa]">アカウント設定、メッセージ、通知、コミュニティ機能の使い方を順次掲載します。</p>
        </div>
      </div>
    </main>
  );
